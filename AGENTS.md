...
- **Serverless Function** — apex → www redirect for Rocks (`apex-redirect-rocks`, `infra/rocks-redirect.tf`), same handler as the `.dev` apex redirect, redeployed under its own name
