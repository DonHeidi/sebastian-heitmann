...
// shape, moved here from the hero (see hero.tsx's makeTear/HERO_TEAR docs for the
// baking technique). The avatar now lives in the About section instead of the hero.
const AVATAR_TEAR =
