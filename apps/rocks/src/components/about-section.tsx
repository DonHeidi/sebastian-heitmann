...
// shape, moved here from the hero. It was baked once from the hero's old seeded
// procedural tear generator (retired in task 20 when the hero's own edge went
// photographic — see hero.tsx's HERO_MASK); the literal path is now the source
// of truth. The avatar lives in the About section instead of the hero.
const AVATAR_TEAR =
