...
export const deDe: Strings = {
  ...
  productValidation: {
    ...
    offer: {
      ...
      included: [
        'Einstiegsworkshop zu Produkt und Positionierung, Wettbewerbs- und Marktbetrachtung, definierte Zielgruppe und zentrales Nutzenversprechen',
        'Websitekonzept, Informationsarchitektur und gemeinsam entwickelte Texte',
        'Individuelles visuelles Design und responsive Entwicklung',
        'Formular für Leads, Warteliste oder Early Access, inklusive Analytics und Conversion-Events',
        'Technische SEO-Grundlagen, Open-Graph-Darstellung, Deployment und produktives Setup',
        'Zwei strukturierte Korrekturschleifen und Übergabe des Quellcodes',
      ],
