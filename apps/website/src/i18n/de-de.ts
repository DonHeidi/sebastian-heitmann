...
export const deDe: Strings = {
  ...
  cv: {
    ...
    summary: 'Technology Consultant mit 10+ Jahren Erfahrung in Software-Architektur, Entwicklung und Team-F\u00FChrung. Ich verbinde tiefe technische Expertise mit Kommunikation und Beratung, um Ideen in ausgelieferte Produkte zu verwandeln.',
    ...
    experience: [
      {
        ...
        highlights: [
          'KI-gest\u00FCtzte Lead-Generierungs-Software f\u00FCr lokale KMU [internes Produkt] entwickelt: erfasst \u00F6ffentliche Unternehmensdaten, extrahiert mit KI strukturierte Gesch\u00E4ftsinformationen und qualifiziert Leads \u00FCber eine mehrstufige Pipeline mit ICP-Targeting, nachvollziehbarer Datenanreicherung und DSGVO-bewusstem Umgang mit personenbezogenen Daten \u2014 TypeScript (Bun), TanStack Start, TailwindCSS, SQLite, PostgreSQL',
          ...
          'Open-Source-AI-Agent-Skill f\u00FCr Online-Writing erstellt und ver\u00F6ffentlicht \u2014 github.com/DonHeidi/online-writing-skills',
