...
export const enUs: Strings = {
  ...
  productValidation: {
    ...
    offer: {
      ...
      included: [
        'Positioning workshop, competitor and market review, and a defined audience and core proposition',
        'Website concept, information architecture, and copy developed with you',
        'Custom visual design and responsive development',
        'Lead, waitlist, or early-access capture, with analytics and conversion events',
        'Technical SEO, Open Graph presentation, deployment, and production setup',
        'Two structured revision rounds and source code handover',
      ],
