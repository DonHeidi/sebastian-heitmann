    ...
    experience: [
      {
        ...
        highlights: [
          'Built an internal AI-assisted lead generation product for local SMBs: ingests public company data, extracts structured business information with AI, and qualifies leads through a multi-step pipeline with ICP targeting, enrichment provenance, and GDPR-aware PII handling \u2014 TypeScript (Bun), TanStack Start, TailwindCSS, SQLite, PostgreSQL',
